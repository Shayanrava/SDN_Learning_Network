...
class S1CriteriaCollector(object):
    ...
    def _handle_FlowStatsReceived(self, event):
        """۲. محاسبه سایر ویژگی‌ها و اعمال drop_rate واقعی در CSV"""
        if event.dpid != 1:
            return
        ...
        if time_diff > 0:
            ...
            # ۴. افزودن drop_rate واقعی به شرط برچسب‌گذاری ازدحام
            is_congested = 1 if (
                kbps > 7500 or 
                drop_rate > 0.02 or   # اگر بیش از ۲ درصد افت بسته داشتیم -> ازدحام
